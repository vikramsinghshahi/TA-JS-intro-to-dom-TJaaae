...
for( i = 0 ; i< allHrsArray.length ; i++){
...
let allHrWithImage = document.querySelectorAll(`.image`);

console.log(allHrWithImage)


allHrWithImage.forEach((ele) => ele.style.border= "2px solid purple");
...
allHrsArray.forEach((ele) => ele.style.borderStyle = "dashed" );
...
imgEle.src = `https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80` ;
